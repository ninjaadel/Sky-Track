...
export function FlightSchedule({ flight }) {
  return (
    <div>
      <div className="grid grid-cols-2 gap-2 mb-1  mx-2  bg-[var(--card)] px-2 ">
        <div
      ...
      <div className="grid grid-cols-2 gap-1  mx-2 py-2 rounded-br-lg rounded-bl-lg bg-[var(--card)] px-2">
        <div
          className="bg-card px-mini-element py-mini-element flex
       items-center justify-between rounded-br-xl rounded-br-xl"
        >
          <p className="text-muted-foreground">Sheduled</p>
          <p>{flight?.scheduledArrival}</p>
        </div>
        <div
          className="bg-card px-mini-element py-mini-element flex
